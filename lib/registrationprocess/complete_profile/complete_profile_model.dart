...
class CompleteProfileModel extends FlutterFlowModel {
  ...
  DateTime? datePicked;
  // State field(s) for procedenceDropdown widget.
  String? procedenceDropdownValue;
  FormFieldController<String>? procedenceDropdownValueController;
  ...
  // State field(s) for chosenTypeUser widget.
  String? chosenTypeUserValue;
  FormFieldController<String>? chosenTypeUserValueController;
