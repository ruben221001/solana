    ...
    return StreamBuilder<List<AfrontationStrategiesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<AfrontationStrategiesRecord>
            supportAfrontationStrategiesRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final supportAfrontationStrategiesRecord =
            supportAfrontationStrategiesRecordList.isNotEmpty
                ? supportAfrontationStrategiesRecordList.first
                : null;
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    fit: BoxFit.contain,
                    image: Image.asset(
                      'assets/images/Community-amico.png',
                    ).image,
                  ),
                ),
                alignment: AlignmentDirectional(0.0, 0.0),
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Row(
                            mainAxisSize: MainAxisSize.max,
                            children: [
                              if (supportAfrontationStrategiesRecord
                                      ?.chosenStrategies
                                ...
                                FlutterFlowIconButton(
                                  ...
                                  onPressed: () async {
                                    await supportAfrontationStrategiesRecord!
                                        .reference
                                        .update({
                          ...
                          children: [
                            ...
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 0.0, 0.0, 24.0),
                              child: Text(
                                'El acudir a otras personas (amigos, familiares, etc) para buscar ayuda, información o también comprensión y apoyo emocional.\n\n\n\n',
                                style: FlutterFlowTheme.of(context)
                                    .titleSmall
                                    .override(
